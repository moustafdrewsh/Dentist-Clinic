...
class RoleController extends Controller
{
    public function list()
    {
        ...
        $date['PermissionAdd'] = PermissionRole::getPermission('Add Role' , Auth::user()->role_id); 
        $date['PermissionEdit']= PermissionRole::getPermission('Edit Role' , Auth::user()->role_id); 
        $date['PermissionDelete'] = PermissionRole::getPermission('Delete Role' , Auth::user()->role_id); 
   ...
   public function insert(Request $request){
    ...
    PermissionRole::InserUpdateRecord($request->permission_id ,  $save->id);
