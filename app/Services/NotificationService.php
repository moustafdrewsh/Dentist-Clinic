...
class NotificationService
{
    ...
    // هنا الفكرة العامة للاشعارات جيث نسطيع ان نجمع انواع الاشعرات لدينا وما لها من اي  احداث
    // حيث نضصع نوع الاشعار مع الحدث الذي نريده وعنجما ينفذ 
    // ينفذ مل حدث حسب دالته ومالها من تبعيات جسب نوع الاشعار
    // notficationSetting -> 
