...
@section('page-header')
    <div class="page-header d-flex align-items-center justify-content-between border-bottom mb-4">
        <h1 class="page-title">إضافة فاتورة جديدة</h1>
        <div>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">الرئيسية</a></li>
                <li class="breadcrumb-item"><a href="{{ route('invoices.index') }}">إدارة الفواتير</a></li>
                <li class="breadcrumb-item active" aria-current="page">إضافة فاتورة جديدة</li>
            </ol>
        </div>
    </div>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card custom-card">
            <div class="card-header">
                <h3 class="card-title">إضافة فاتورة جديدة</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('invoices.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="issued_date" id="issued_date" class="form-control @error('issued_date') is-invalid @enderror" value="{{ old('issued_date') }}">
                        @error('issued_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
