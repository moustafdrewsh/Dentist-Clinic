            ...
            <div class="header-element">
                <div class="horizontal-logo">
                    <a href="index.html" class="header-logo">
                        ...
                        <img src="{{ asset('assets/images/brand/toggle-logo.png') }}" alt="logo"
                            class="toggle-logo">
                        <img src="{{ asset('assets/images/brand/desktop-dark.png') }}" alt="logo"
                            class="desktop-dark">
                        <img src="{{ asset('assets/images/brand/toggle-dark.png') }}" alt="logo"
                            class="toggle-dark">
                    </a>
                </div>
            </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                    <div class="d-flex align-items-center">
                                ...
                                <ul class="mb-0 overflow-auto" id="header-cart-items-scroll">
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-start cart-dropdown-item">
                                            <img src="{{ asset('assets/images/products/1.jpg') }}" alt="img"
                                    ...
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-start cart-dropdown-item">
                                            <img src="{{ asset('assets/images/products/2.jpg') }}" alt="img"
                                                class="avatar avatar-md br-5 me-3">
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-start justify-content-between mb-0">
                                    ...
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-start cart-dropdown-item">
                                            <img src="{{ asset('assets/images/products/3.jpg') }}" alt="img"
                                                class="avatar avatar-md br-5 me-3">
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-start justify-content-between mb-0">
                                                    <div class="mb-0 fs-14 text-dark fw-semibold">
                                    ...
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-start cart-dropdown-item">
                                            <img src="{{ asset('assets/images/products/5.jpg') }}" alt="img"
                                                class="avatar avatar-md br-5 me-3">
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-start justify-content-between mb-0">
                                                    <div class="mb-0 fs-14 text-dark fw-semibold">
                                ...
                                <div class="p-5 empty-item d-none">
                                    <div class="text-center">
                                        ...
                                        <a href="shop.html" class="btn btn-primary btn-wave btn-sm m-1"
                                            data-abc="true">Back to Shop <i class="bi bi-arrow-right ms-1"></i></a>
                                    </div>
                                </div>
                            </div>
                            <!-- End::main-header-dropdown -->
                        ...
                        <div class="header-element dropdown-center notifications-dropdown">
                            <!-- Start::header-link|dropdown-toggle -->
                            <a href="javascript:void(0);" class="header-link dropdown-toggle"
                                data-bs-toggle="dropdown" aria-expanded="false" id="notification-dropdown">
                                <svg xmlns="http://www.w3.org/2000/svg" class="header-link-icon" viewBox="0 0 24 24">
                                    <path d="M0 0h24v24H0V0z" fill="none" />
                                    <path
                            ...
                            <div class="main-header-dropdown dropdown-menu dropdown-menu-end"
                                ...
                                <div class="p-3">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="javascript:void(0);" class="badge bg-secondary-transparent"
                                            id="notification-data">0 Items</a>
                                    </div>
                                </div>
                                ...
                                <div class="p-3 empty-header-item1 d-none">
                                    <div class="d-grid">
...
<script>
    ...
    var pusher = new Pusher('837a0dd196a3c9792120', {
        cluster: 'eu'
    });
    var channel = pusher.subscribe('notify-sham');
    ...
    function updateNotificationList() {
        ...
        $('#notification-data').text(notificationCount + " Items");
        $('#notification-icon-badge').text(notificationCount); // تحديث العدد في الشارة

        // إظهار أو إخفاء الزر "عرض الكل" بناءً على الإشعارات
        if (notificationCount > 0) {
            $('#notification-list').parent().find('.empty-header-item1').removeClass('d-none');
            $('#notification-list').parent().find('.empty-item1').addClass('d-none');
        } else {
            $('#notification-list').parent().find('.empty-header-item1').addClass('d-none');
            $('#notification-list').parent().find('.empty-item1').removeClass('d-none');
        }
    }
